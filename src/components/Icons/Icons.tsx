...
export function SunIcon({ size = 24, ...props }: SvgProps) {
  return (
    <svg {...svgProps(size, props)}>
...
export function MoonIcon({ size = 24, ...props }: SvgProps) {
  return (
    <svg {...svgProps(size, props)}>
...
export function DatabaseIcon({ size = 24, ...props }: SvgProps) {
  return (
    <svg {...svgProps(size, props)}>
...
export function CheckCircleIcon({ size = 24, ...props }: SvgProps) {
  return (
    <svg {...svgProps(size, props)}>
